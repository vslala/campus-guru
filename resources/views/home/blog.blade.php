                ...
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="h4"><a href="{{ route('showSingleBlog', ["id"=>$b->id, "heading"=>$b->heading]) }}"> {{ $b->heading or 'heading not set' }} </a><span style="color: lightgray; font-size: xx-small;">(user's view)</span></div>
                            <br />
